...
Cool.Name = "coolt1tan2020 gui"
Cool.Parent = game.CoreGui
Cool.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
function coolLib:Notification(title, desc)
    Notify:New(title,desc)
end    

function coolLib:New(Config)
    ...
    if not isfile(Config.FolderToSave .. "/settings.txt") then
        local content = {}
        for i,v in pairs(coolLib.Settings) do
            content[i] = v
        end
        writefile(Config.FolderToSave .. "/settings.txt", tostring(http:JSONEncode(content)))
    end    
    coolLib.Settings = http:JSONDecode(readfile(Config.FolderToSave .. "/settings.txt"))
    ...
    function MusicConstructor()
        ...
        MusicFrame.Parent = cool
        MusicFrame.ZIndex = 5
        MusicFrame.Visible = coolLib.Settings.ShowMusicOnLaunch
        ...
        spawn(function()
            while wait() do
                MusicFrame.Frame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].MainFrame
                MusicFrame.Frame.TopBar.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TopBar
                MusicFrame.Frame.TopBar.CloseBtn.Ico.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                MusicFrame.Frame.MusicList.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].TopBar
                MusicFrame.Frame.AddBtn.BackgroundColor3 = abuttonhold and coolLib.Themes[coolLib.Settings.Theme].ButtonHold or coolLib.Themes[coolLib.Settings.Theme].Button
                MusicFrame.Frame.Progress.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Slider
                MusicFrame.Frame.Progress.ProgressFrame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].SliderInc
                MusicFrame.Frame.AddSong.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Textbox
            end
        end)
    end  
    ...
    function SettingsConstructor()
        ...
        spawn(function()
            while wait() do
                SFrame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].MainFrame
                SFrame.TopBar.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TopBar
                SFrame.TopBar.CloseBtn.Ico.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                SFrame.TopBar.TopFrameTitle.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                SFrame.TabHolder.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].TopBar
        ...
        function Settings:Tab(text)
            ...
            function TabHold:ToggleSetting(title, desc, def, path)
                local value = coolLib.Settings[path] or def
                ...
                spawn(function()
                    while wait() do
                        Toggle.ToggleFrame.ToggleToggled.BackgroundColor3 = value and coolLib.Themes[coolLib.Settings.Theme].ToggleToggled or coolLib.Themes[coolLib.Settings.Theme].MainFrame
                        Toggle.ToggleFrame.BackgroundColor3 = value and coolLib.Themes[coolLib.Settings.Theme].ToggleToggled or coolLib.Themes[coolLib.Settings.Theme].ToggleFrame
                        Toggle.Title.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)
            end
            function TabHold:BindSetting(title, desc, def, path)
                ...
                spawn(function()
                    while wait() do
                        Bind.Desc.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                        Bind.BText.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                        Bind.Title.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)
            ...
            function TabHold:Dropdown(title, desc, list, def, path)
                ...
                local function AddOptions(opts)
                    for _,option in pairs(opts) do
                        ...
                        spawn(function()
                            while wait() do
                               Option.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor       
                            end
                        end)
                    end   
                end    
                ...
                spawn(function()
                    while wait() do
                        Dropdown.Main.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TopBar
                        Dropdown.Main.Holder.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TopBar
                    end
                end)
                AddOptions(list)
            end
    ...
    function SearchConstructor()
        function StitchElements()
            local elms = {}
            for i,v in next, coolLib.CurrentTab:GetDescendants() do
	...
	UserInputService.InputBegan:Connect(function(Input)
		if (Input.KeyCode.Name == coolLib.Settings.CloseBind or Input.UserInputType.Name == coolLib.Settings.CloseBind) and not closebindbinding then
            uitoggled = not uitoggled
            MainUI.Visible = uitoggled
		end
	end)
    ...
    spawn(function()
        while wait() do
            MFrame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].MainFrame
            MFrame.TopBar.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TopBar
            MFrame.TopBar.ButtonHolder.CloseBtn.Ico.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            MFrame.TopBar.ButtonHolder.MenuBtn.Ico.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            MFrame.TopBar.ButtonHolder.SearchBtn.Ico.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            MFrame.TopBar.TabListBtn.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            MFrame.TopBar.TopFrameTitle.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            MFrame.TabMenu.Menu.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Menu
            MFrame.TabMenu.Menu.Top.MenuCloseBtn.ImageLabel.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            MFrame.TopBar.ButtonHolder.SearchBtn.TextBox.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].MainFrame
            MFrame.TopBar.ButtonHolder.SearchBtn.TextBox.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            MFrame.TopBar.ButtonHolder.SearchBtn.TextBox.PlaceholderColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            MFrame.TopBar.ButtonHolder.MenuBtn.MenuFrame.Frame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].TopBar
        end
    end)

    function coolLib:LoadCfg(cfg)
        local content = http:JSONDecode(cfg)
        table.foreach(content, function(a,b)
            if coolLib.Flags[a] then
                spawn(function() coolLib.Flags[a]:Set(b) end)
            else
    ...
    function coolLib:SaveCfg(name)
        local content = {}
        for i,v in pairs(coolLib.Flags) do
            content[i] = v.Value
        end
    ...
    function TabHolder:Tab(text)
        ...
        if fs == false then
            ...
            coolLib.CurrentTab = Container  
        end    

        spawn(function()
            while wait() do
                Tab.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                Tab.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].TabToggled
        ...
        function SectionHold:Section(text)
            ...
            spawn(function()
                while wait() do
                    Section.SectionTitle.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
            ...
            function ItemHold:Button(text,callback)
                ...
                spawn(function()
                    while wait() do
                       Button.BackgroundColor3 = Holding and coolLib.Themes[coolLib.Settings.Theme].ButtonHold or coolLib.Themes[coolLib.Settings.Theme].Button
                       Button.ButtonText.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)
            ...
            function ItemHold:Toggle(text,def,flag,callback)
                ...
                spawn(function()
                    while wait() do
                        ToggleMain.ToggleFrame.ToggleToggled.BackgroundColor3 = Toggle.Value and coolLib.Themes[coolLib.Settings.Theme].ToggleToggled or coolLib.Themes[coolLib.Settings.Theme].Toggle
                        ToggleMain.ToggleFrame.BackgroundColor3 = Toggle.Value and coolLib.Themes[coolLib.Settings.Theme].ToggleToggled or coolLib.Themes[coolLib.Settings.Theme].ToggleFrame
                        ToggleMain.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Toggle
                        ToggleMain.ToggleText.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)

				Toggle:Set(def)
                coolLib.Flags[flag] = Toggle
                return Toggle
            end    
            function ItemHold:Slider(text,min,max,start,inc,flag,callback)
                ...
                spawn(function()
                    while wait() do
                       SliderMain.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Slider
                       SliderMain.SliderFrame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].SliderBar
                       SliderMain.SliderFrame.SliderCurrentFrame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].SliderInc
                       SliderMain.SliderText.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                       SliderMain.SliderVal.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)


                Slider:Set(start)
                coolLib.Flags[flag] = Slider
                return Slider
            end    
            function ItemHold:Dropdown(text,list,def,flag,callback)
                ...
                local function AddOptions(opts)
                    for _,option in pairs(opts) do
                        ...
                        spawn(function()
                            while wait() do
                               Option.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].DropdownItem
                               DropMain.Btn.Title.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                            end
                        end)
                    end   
                end    
                ...
                spawn(function()
                    while wait() do
                       DropMain.Btn.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Dropdown
                       DropMain.Btn.Title.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                       DropMain.Btn.Ico.ImageColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)

                Dropdown:Refresh(list,false)
                Dropdown:Set(def)
                coolLib.Flags[flag] = Dropdown
                return Dropdown
            end   
            ...
            function ItemHold:Colorpicker(text,preset,flag,callback)
                ...
                spawn(function()
                    while wait() do
                       ColorPreset.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Colorpicker
                       ColorPreset.Btn.Colorpicker.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)
            ...
            function ItemHold:Label(text)
                ...
                spawn(function()
                    while wait() do
                       LabelFrame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Label
                       LabelFrame.Title.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)
            ...
            function ItemHold:Textbox(text,disappear,callback)
                ...
                spawn(function()
                    while wait() do
                       TextboxFrame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Textbox
                       TextboxFrame.Title.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                       TextboxFrame.Box.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].TextboxFrame
                       TextboxFrame.Box.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)
                return Textbox
            end    
            function ItemHold:Bind(text,preset,holdmode,flag,callback)
                ...
                spawn(function()
                    while wait() do
                       BindFrame.BackgroundColor3 = coolLib.Themes[coolLib.Settings.Theme].Bind
                       BindFrame.Title.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                       BindFrame.BText.TextColor3 = coolLib.Themes[coolLib.Settings.Theme].TextColor
                    end
                end)

				Bind:Set(preset)
                coolLib.Flags[flag] = Bind
                return Bind
            end    
            return ItemHold
        end    
